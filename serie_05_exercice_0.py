...
WINDOW_TITLE: str = "pygame_step_22"
...
class Spaceship(Actor):
    __size: pygame.Vector2   #pour aller dans la class spaceship afin de donner une valeur en vecteur pour spaceship et un diametre en int pour asteroid
...
#pour que ça nous dise après si on a oublié de coder les def importantes pour chaque sous class
...
class SpaceshipSprite(ActorSprite):
    ...
    def __init__(self, spaceship: Spaceship) -> None:
        super().__init__(spaceship, pygame.Color(pygame.color.THECOLORS["magenta"]))
...
class Game:
    ...
    def __init_spaceship(self) -> None:
        ...
        spaceship_sprite = SpaceshipSprite(spaceship)
    ...
    def __handle_spaceship_collisions_with_asteroids(self):
        ...
        for hinted_asteroid_sprite in hinted_asteroids_sprites:
            ...
            #hinted_asteroid_sprite.actor.diameter = 10
